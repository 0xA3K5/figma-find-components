...
export default function ActionBar(
  ...
  return (
    ...
    >
      <div className="flex w-64 gap-1 rounded-xl border border-black border-opacity-10 bg-white px-3 py-2 dark:border-white dark:border-opacity-10 dark:bg-black dark:bg-opacity-5">
